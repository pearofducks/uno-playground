...
export declare type Shift<T> = T extends [_: any, ...args: infer A] ? A : never;
export declare type RestArgs<T> = Shift<ArgumentType<T>>;
export declare type DeepPartial<T> = {
    [P in keyof T]?: DeepPartial<T[P]>;
};
export declare type FlatObjectTuple<T> = {
    [K in keyof T]: T[K];
};
export declare type PartialByKeys<T, K extends keyof T = keyof T> = FlatObjectTuple<Partial<Pick<T, Extract<keyof T, K>>> & Omit<T, K>>;
export declare type RequiredByKey<T, K extends keyof T = keyof T> = FlatObjectTuple<Required<Pick<T, Extract<keyof T, K>>> & Omit<T, K>>;
export declare type CSSObject = Record<string, string | number | undefined>;
export declare type CSSEntries = [string, string | number | undefined][];
export interface CSSColorValue {
    type: string;
    components: (string | number)[];
    alpha: string | number | undefined;
}
export declare type RGBAColorValue = [number, number, number, number] | [number, number, number];
...
export declare type PresetOptions = Record<string, any>;
...
export declare type CSSValue = CSSObject | CSSEntries;
export declare type CSSValues = CSSValue | CSSValue[];
export declare type DynamicMatcher<Theme extends {} = {}> = ((match: RegExpMatchArray, context: Readonly<RuleContext<Theme>>) => Awaitable<CSSValue | string | (CSSValue | string)[] | undefined>);
export declare type DynamicRule<Theme extends {} = {}> = [RegExp, DynamicMatcher<Theme>] | [RegExp, DynamicMatcher<Theme>, RuleMeta];
export declare type StaticRule = [string, CSSObject | CSSEntries] | [string, CSSObject | CSSEntries, RuleMeta];
export declare type Rule<Theme extends {} = {}> = DynamicRule<Theme> | StaticRule;
export declare type DynamicShortcutMatcher<Theme extends {} = {}> = ((match: RegExpMatchArray, context: Readonly<RuleContext<Theme>>) => (string | ShortcutValue[] | undefined));
export declare type StaticShortcut = [string, string | ShortcutValue[]] | [string, string | ShortcutValue[], RuleMeta];
export declare type StaticShortcutMap = Record<string, string | ShortcutValue[]>;
export declare type DynamicShortcut<Theme extends {} = {}> = [RegExp, DynamicShortcutMatcher<Theme>] | [RegExp, DynamicShortcutMatcher<Theme>, RuleMeta];
export declare type UserShortcuts<Theme extends {} = {}> = StaticShortcutMap | (StaticShortcut | DynamicShortcut<Theme> | StaticShortcutMap)[];
export declare type Shortcut<Theme extends {} = {}> = StaticShortcut | DynamicShortcut<Theme>;
export declare type ShortcutValue = string | CSSValue;
...
export declare type BlocklistRule = string | RegExp;
...
export declare type VariantFunction<Theme extends {} = {}> = (matcher: string, context: Readonly<VariantContext<Theme>>) => string | VariantHandler | undefined;
...
export declare type Variant<Theme extends {} = {}> = VariantFunction<Theme> | VariantObject<Theme>;
export declare type Preprocessor = (matcher: string) => string | undefined;
export declare type Postprocessor = (util: UtilObject) => void;
export declare type ThemeExtender<T> = (theme: T) => void;
...
export declare type AutoCompleteTemplate = string;
export declare type AutoCompleteFunction = (input: string) => Awaitable<string[]>;
...
export declare type SourceCodeTransformerEnforce = 'pre' | 'post' | 'default';
...
export interface ResolvedConfig extends Omit<RequiredByKey<UserConfig, 'mergeSelectors' | 'theme' | 'rules' | 'variants' | 'layers' | 'extractors' | 'blocklist' | 'safelist' | 'preflights' | 'sortLayers'>, 'rules' | 'shortcuts' | 'autocomplete'> {
    presets: Preset[];
    shortcuts: Shortcut[];
...
export declare type VariantMatchedResult = readonly [
    raw: string,
    current: string,
    variantHandlers: VariantHandler[],
    variants: Set<Variant>
];
export declare type ParsedUtil = readonly [
    index: number,
    raw: string,
    entries: CSSEntries,
...
export declare type RawUtil = readonly [
    index: number,
    rawCSS: string,
    meta: RuleMeta | undefined
];
export declare type StringifiedUtil = readonly [
    index: number,
...
export declare type PreparedRule = readonly [
