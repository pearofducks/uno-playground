 ...
 */
export function presetForms() {
  return {
    name: 'unocss-preset-forms',
    preflights: [
      {
        getCSS: ({ theme }) => {
          const spacing = ['1px', '100px', '1000px']
          ...
          const rules = [
            {
              ...
              styles: {
                ...
                'border-color': 'var(--p-border-form)',
            ...
            },
            {
              ...
              styles: {
                'background-image': `url("${svgToDataUri(
                  `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20"><path stroke="${'red'}" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M6 8l4 4 4-4"/></svg>`
                )}")`,
...
const r = presetForms()
r.preflights[0].getCSS({ theme: { spacing: {} } })
